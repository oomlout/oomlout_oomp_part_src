...
def get_footprints(**kwargs):
    ...
    match["footprint_name"] = "akiyukiokayasu_kicad_akiyuki_footprint_raspberrypipico_smd_th"
    matches.append(match)
    ...
    for pin_count in range(1, 41):
        ...
        match["description_extra"] = "through_hole"
        match["footprint"] = []
